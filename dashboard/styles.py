...
/* Dark Mode - Card-like elements (GitHub style) */
[data-theme="dark"] .card {
    background-color: var(--bg-primary) !important;
    border-color: var(--border-default) !important;
}

/* Specific targeting for dashboard cards - avoid using !important on divs */
[data-theme="dark"] [style*="padding"][style*="border-radius"][style*="box-shadow"] {
    background-color: var(--bg-secondary) !important;
    border-color: var(--border-default) !important;
}

/* Info/Tip banners in dark mode */
[data-theme="dark"] [style*="background-color: rgb(255, 244, 230)"],
[data-theme="dark"] [style*="background-color: #fff4e6"] {
